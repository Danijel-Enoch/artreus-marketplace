            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <div>
                      <button className="flex justify-between items-center p-3 w-[70%] my-2 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" onClick={() => handleMetamask()}>
                    ...
                    <div>
                      <button className="flex justify-between items-center w-[70%] p-3 my-2 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" onClick={() => handleNear()}>

                        <div className='mx-2 items-center flex'>
                          <img src='/near.png' className='w-5 h-4' />
                          <span className="flex-1 ml-2 whitespace-nowrap">Near</span>
                        </div>
                        <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-200 rounded dark:bg-gray-700 dark:text-gray-400">Mobile</span>
                      </button>
                    </div>
