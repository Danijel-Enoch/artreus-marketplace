  ...
  return (
    <div className="w-[100%] h-[100%] md:mt-3">
      ...
      <div className='flex justify-center items-center'>
        <div className='w-[100%] h-[550px] bg-[#ccc] rounded-lg flex justify-center items-center ' style={{ backgroundImage: `url(${imageUrl})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat",backgroundColor:"#2F2F2F1A" }}>
