...
const FilterButton=({label}:{label:string})=>{
    return(<button className='bg-[#e4e2e2] inline-flex whitespace-nowrap md:flex items-center justify-between p-1 md:py-1 md:px-4 border-black border rounded-lg md:font-semibold text-brandpurple capitalize'>{label}<svg className='ml-2' width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
