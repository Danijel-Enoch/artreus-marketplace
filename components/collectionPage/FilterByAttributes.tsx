...
{size.width&&size.width >= 765&&(<h2 className='text-brandbrown font-semibold flex justify-between mb-2'><span className='block'>Filter </span><button><svg  className="block" width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
