...
export default function Main({children}:{children:React.ReactNode}) {
  ...
  return (
    ...
    <header className='py-4 px-6 bg-brandbrown flex justify-between'>
    ...
    <main className='px-10'>
          ...
          <input type="text" placeholder="Search Collections or creator" className='w-[80%] max-w-[700px] bg-[#e0dfdf] border border-[#e0dfdf] px-6 py-2 rounded-xl'/>
