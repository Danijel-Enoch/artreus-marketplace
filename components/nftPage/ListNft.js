...
=======
        {listed ? (
          ...
          <>
            {buyer === true ? <>
              <button className='py-2 px-6 bg-brandpurple text-brandyellow rounded-md flex mr-5'>Cancel Listing</button>
              <button className='py-2 px-6 bg-brandpurple text-brandyellow rounded-md flex'>Change Price</button>
            </> :
              <>
                <button className='py-2 px-6 bg-brandpurple text-brandyellow rounded-md flex'>Buy</button>
              </>
            }
          </>
          ...
          <>
            <button onClick={() => makeOffer(price, nft, mintAddress)} className='py-2 px-6 bg-brandpurple text-brandyellow rounded-md flex'><span className='block font-bold mr-1'><svg
              xmlns="http://www.w3.org/2000/svg"
              className='inline mr-1'
              width="14"
              height="14"
            ...
            <button onClick={() => approve(nft)} className='py-2 px-6 bg-brandpurple text-brandyellow rounded-md flex'><span className='block font-bold mr-1'><svg
              xmlns="http://www.w3.org/2000/svg"
              className='inline mr-1'
              width="14"
              height="14"
