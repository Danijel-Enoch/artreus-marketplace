  ...
  return (
    <>
      <div className='flex items-center w-full bg-brandpurple px-4 py-4' >
        <button name="left-arrow-button" className="border-0" onClick={() => { onBackButtonPresssed() }}>
        ...
        <button name="search-button" className="border-0" onClick={() => { onSearch() }}>
      ...
      <div className='relative'>
        <div className='bg-[#ccc] px-4 pt-4 pb-48 absolute w-full z-10'>
          <div className='flex justify-between'>
            <h3 className='text-bodycopy font-bold'>Recent</h3>
            <h3 className='text-bodycopy '>Clear</h3>

          </div>

          <div className='space-y-4 mt-4  flex flex-col justify-center '>
            {recentSearches.map((search, index) => (
              <p className=' capitalize text-[#2F2F2F] ' key={index}><svg className="inline-block mr-2 " width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.6663 8.00016C14.6663 11.6802 11.6797 14.6668 7.99967 14.6668C4.31967 14.6668 1.33301 11.6802 1.33301 8.00016C1.33301 4.32016 4.31967 1.3335 7.99967 1.3335C11.6797 1.3335 14.6663 4.32016 14.6663 8.00016Z" stroke="#2F2F2F" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M10.4729 10.1202L8.40626 8.88684C8.04626 8.6735 7.75293 8.16017 7.75293 7.74017V5.00684" stroke="#2F2F2F" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
